...
- **User-Friendly Interface:** Clean layout with a "Reset / New Round" functionality.

## 🛠️ Tech Stack
- **Language:** Python 3.14
- **Library:** Tkinter (Python's standard GUI library)
- **Environment:** PyCharm
- **Version Control:** Git & GitHub (with custom `.gitignore` implementation)

## 🚀 How to Run
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/DenisFlorin15/Typing-Speed-Test-Python.git](https://github.com/DenisFlorin15/Typing-Speed-Test-Python.git)
...
- Version Control Best Practices: Implementing a .gitignore to separate source code from local data and IDE configurations.

---

*Developed by Denis Florin Piele as part of the 100 Days of Code journey.*
